...
CONSTANCE_CONFIG = {
    ...
    'REPLACEMENT_DIRECTOR_TITLE': ("Η Αναπληρώτρια Δ/ντρια της Δ/νσης Δ/θμιας Εκπ/σης Ηρακλείου", "Ονοματεπώνυμο του αναπληρωτή του διευθυντή της υπηρεσίας"),
    'REPLACEMENT_DIRECTOR_NAME': ("ΣΤΥΛΙΑΝΗ ΜΑΚΡΥΓΙΑΝΝΑΚΗ", "Τίτλος του αναπληρωτή του διευθυντή της υπηρεσίας"),
}
