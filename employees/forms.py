...
class EmployeeSearchForm(forms.Form):
    ...
    enabled = forms.BooleanField(label='Σε ενεργεία', required=False)
    employee_type = forms.ChoiceField(label="Τύπος Εκπαιδευτικού", choices=blank_choice + EmployeeType.choices, required=False)
